          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-center justify-between py-3 border-b border-spa-beige-200 dark:border-slate-600">
                  <span className="font-poppins font-medium text-spa-black dark:text-spa-white">{schedule.day}</span>
                  <span className="font-poppins text-spa-beige-600 dark:text-spa-beige-400">{schedule.hours}</span>
                </div>
              ))}
            </div>
